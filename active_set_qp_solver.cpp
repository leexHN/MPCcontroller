...
bool ActiveSetQpSolver::Solve() {
  ...
  std::unique_ptr<double> u_ptr1(new double[kNumOfMatrixElements]);
  double* h_matrix= u_ptr1.get();  // NOLINT

  const auto kNumOfOffsetRows = offset_.rows();
  std::unique_ptr<double> u_ptr2(new double[kNumOfOffsetRows]);
  double* g_matrix=u_ptr2.get();  // NOLINT
  int index = 0;
  ...
  std::unique_ptr<double> u_ptr3(new double[num_param_]);
  std::unique_ptr<double> u_ptr4(new double[num_param_]);
  double* lower_bound= u_ptr3.get();  // NOLINT
  double* upper_bound = u_ptr4.get();  // NOLINT
  ...
  std::unique_ptr<double> u_ptr5(new double[num_param_ * num_constraint_]);
  std::unique_ptr<double> u_ptr6(new double[num_constraint_]);
  std::unique_ptr<double> u_ptr7(new double[num_constraint_]);
  double* affine_constraint_matrix= u_ptr5.get();  // NOLINT
  double* constraint_lower_bound = u_ptr6.get();                 // NOLINT
  double* constraint_upper_bound = u_ptr7.get();                 // NOLINT
  index = 0;
  ...
  std::unique_ptr<double> u_ptr8(new double[num_param_]);
  double* result= u_ptr8.get();  // NOLINT
