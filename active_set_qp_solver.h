...
#define USE_default_option
#define FLAGS_default_active_set_eps_num 1.0
#define FLAGS_default_active_set_eps_den 1.0
#define FLAGS_default_active_set_eps_iter_ref 100

#define FLAGS_default_enable_active_set_debug_info true
